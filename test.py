...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 09:48:41 2023
...
model = YOLO('/Users/skasmani/Downloads/IBM/ibm-repo/image_classification_microservice_pytorch/yolov8l.pt')
...
obd_image = plot_bboxes(image, results[0].boxes.data, score=False)

plt.imshow(obd_image) #if used in Python
plt.show()
